import{a as c,b as x,c as P}from"./chunk-SGZ2B7FA.js";import{C as u,E as d,I as A,L as k,M as m,w as n}from"./chunk-FYWJBKMT.js";import{B as O,C as _,H as j,P as L,T,Z as E,a as S,ba as p,ia as $}from"./chunk-TJ36ROFO.js";var D=(function(e){return e.approve="approved",e.bought="bought",e.borrow="borrowed",e.burn="burnt",e.cancel="canceled",e.claim="claimed",e.deploy="deployed",e.deposit="deposited",e.execute="executed",e.mint="minted",e.receive="received",e.repay="repaid",e.send="sent",e.sell="sold",e.stake="staked",e.trade="swapped",e.unstake="unstaked",e.withdraw="withdrawn",e})(D||{});var U=d`
  :host > wui-flex {
    display: flex;
